...
public class clientNetworkUtils {
  ...
  public echoData getSerializedEchoData() throws IOException, ClassNotFoundException {
    setReceivePacket();
...
//    System.out.println("a FROM Server: the size of byte data in packet is " + receivePacket.getLength());
  ...
  public void sendSerializedEchoData(echoData data) throws IOException, ClassNotFoundException {
